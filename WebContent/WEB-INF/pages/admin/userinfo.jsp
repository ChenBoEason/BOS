...
<body class="easyui-layout" style="visibility:'visible';">
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
       <form id="addUserForm" action="${pageContext.request.contextPath}/userAction_addUser.action" method="post" >
           <table class="table-edit"  width="95%" align="center">
				...
				<tr>
	           	...
	           	<tr><td>备注:</td>
	           	<td colspan="3"><textarea style="width:80%" name="remark">
	           	</textarea></td></tr>
	           	<tr>
	           		<td>选择角色</td>
	           		<td colspan="10" id="roleTD">
	           			<script type="text/javascript">
							var url1 = "${pageContext.request.contextPath}/roleAction_listAjax.action";
							$.post(url1,{},function(data){
								for (var i = 0; i < data.length; i++) {
									var id = data[i].id;
									var name = data[i].name;
									$("#roleTD").append("<input type='checkbox' value='"+id+"' name='roleId'>"+name);
								}
							},'json');
	           			</script>
	           		</td>
