...
<script type="text/javascript">
	...
	function doExport(){
		window.location.href = "${pageContext.request.contextPath}/subareaAction_expotXls.action";
	}
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div style="height:31px;overflow:hidden;" split="false" border="false" >
			<div class="datagrid-toolbar">
				...
				<script type="text/javascript">
					$(function(){
						$("#save").click(function(){
								var v = $("#addSubarea").form("validate");
								if(v){
									$("#addSubarea").submit();						
								}
							});
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addSubarea"  method="post"
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							...
    							url:'${pageContext.request.contextPath }/regionAction_pageListAjax.action'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
