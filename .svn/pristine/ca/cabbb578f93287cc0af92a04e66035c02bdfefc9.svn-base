...
<script type="text/javascript">
	...
	// 版权信息
	function showAbout(){
		$.messager.alert("宅急送 v1.0","管理员邮箱: 2293230160@qq.com");
	}
</script>
</head>
<body class="easyui-layout">
				...
				<tr>
					<td style="width: 300px;">
						<div style="color: #999; font-size: 8pt;">
							Eason | Powered by <a href="#">Eason</a>
						</div>
					</td>
               ...
               <form id="editPasswordForm">
                <table cellpadding=3>
                    ...
                    <tr>
                        ...
                        required="required" validType="length[3,8]"/></td>
                    </tr>
                </table>
                </form>
            </div>
    ...
    <script type="text/javascript">
	    $("#btnEp").click(function(){
			//$("#editPasswordForm").form("validate"); 表单中全部复合要求为true 一个不符合为false
